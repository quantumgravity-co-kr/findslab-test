...
const Select = ({items, className, essential, control, name, theme = 'normal', placeholder, onChange: _onChange}: props) => {
  const defaultValue = essential && items && items.length > 0 ? items[0].value : undefined;
